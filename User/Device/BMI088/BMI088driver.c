...
#define BMI088_OFFLINE_TIMEOUT_MS 10U
#define INS_OFFLINE_TIMEOUT_MS    20U
  ...
  for(uint16_t i = 0; i < 5000; i++)
  {
    ...
    if(buf[0] == BMI088_GYRO_CHIP_ID_VALUE)   
    {
      ...
      BMI088_Info->Offsets_Gyro_Z += BMI088_GYRO_SEN * BMI088_Info->MPU_Info.Gyro_Z;
		BMI088_Info->Offsets_Gyro_X =  0.000398833858;
        BMI088_Info->Offsets_Gyro_Y =  0.00279888161;
        BMI088_Info->Offsets_Gyro_Z = -0.000292095967;
    }
    /* waiting 1ms */
    DWT_Delay_ms(1);
  }
...
void BMI088_Init(void)
{
  ...
  /* Initializes the BMI088 */
    ...
    INS_Info.INS_last_rx_time_ms = BMI088_Info.Last_Update_Time;
