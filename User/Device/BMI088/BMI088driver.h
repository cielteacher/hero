...
typedef struct
{
    ...
    int16_t YawRoundCount;//   圈数
    uint8_t INS_online_flag; // 在线标志
    uint32_t INS_last_rx_time_ms; // INS上次接收数据的时间戳
...
extern void BMI088_AliveCheck(void);
extern void INS_AliveCheck(void);
