...
void Kalman_Filter_Init(KalmanFilter_Info_TypeDef *KF, uint8_t Xhat_Size, uint8_t U_Size, uint8_t Z_Size)
{
  ...
  KF->MeasuredVector = (float *)RMLIB_MALLOC(KF->sizeof_float * Z_Size);
  memset(KF->MeasuredVector, 0, KF->sizeof_float * Z_Size);

  /* Initializes the Xhat */
  KF->Data.Xhat = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size);
  ...
  KF->Data.Xhatminus = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size);
  ...
  KF->Data.Z = (float *)RMLIB_MALLOC(KF->sizeof_float * Z_Size);
  ...
  KF->Data.A = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Xhat_Size);
  memset(KF->Data.A, 0, KF->sizeof_float * Xhat_Size * Xhat_Size);
  Matrix_Init(&KF->Mat.A, KF->Xhat_Size, KF->Xhat_Size, (float *)KF->Data.A);

  KF->Data.AT = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Xhat_Size);
  ...
  KF->Data.H = (float *)RMLIB_MALLOC(KF->sizeof_float * Z_Size * Xhat_Size);
  memset(KF->Data.H, 0, KF->sizeof_float * Z_Size * Xhat_Size);
  Matrix_Init(&KF->Mat.H, KF->Z_Size, KF->Xhat_Size, (float *)KF->Data.H);

  KF->Data.HT = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Z_Size);
  ...
  KF->Data.P = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Xhat_Size);
  ...
  KF->Data.Pminus = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Xhat_Size);
  ...
  KF->Data.Q = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Xhat_Size);
  ...
  KF->Data.R = (float *)RMLIB_MALLOC(KF->sizeof_float * Z_Size * Z_Size);
  ...
  KF->Data.K = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size * Z_Size);
  ...
  KF->Data.K_denominator = (float *)RMLIB_MALLOC(KF->sizeof_float * KF->Xhat_Size * KF->Xhat_Size);
  ...
  KF->Data.Cache_Matrix[0] = (float *)RMLIB_MALLOC(KF->sizeof_float * KF->Xhat_Size * KF->Xhat_Size);
  ...
  KF->Data.Cache_Matrix[1] = (float *)RMLIB_MALLOC(KF->sizeof_float * KF->Xhat_Size * KF->Xhat_Size);
  ...
  KF->Data.Cache_Vector[0] = (float *)RMLIB_MALLOC(KF->sizeof_float * KF->Xhat_Size);
  ...
  KF->Data.Cache_Vector[1] = (float *)RMLIB_MALLOC(KF->sizeof_float * KF->Xhat_Size);
  ...
  KF->Output = (float *)RMLIB_MALLOC(KF->sizeof_float * Xhat_Size);
